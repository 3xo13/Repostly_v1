...
const MapSection = () => {
    ...
    return (
        <div className="w-full border border-[#E5E7EB] p-6 rounded-[18px] bg-[#FFFFFF] lg:w-[40%]">
            <h1 className="text-[#111827] font-medium">Active posts map</h1>
            ...
            {isMapVisible && (
                <MapContainer key="unique-map"
                    ...
                    // Center of France
                    zoom={6} style={{ minHeight: "500px", width: "100%" }} className="rounded-[11px] lg:h-[90%] relative -z-0">
                    <TileLayer
            ...
            {selectedRegion && (
                <div className="mt-4">
                    ...
                    <p><strong>Name:</strong> {selectedRegion.nom}</p>
                    <p><strong>Code:</strong> {selectedRegion.code}</p>
                </div>
            )}
        </div>
    );
...
//     return (
//         <div
//             className="w-full border border-[#E5E7EB] p-6 rounded-[18px] bg-[#FFFFFF] lg:w-[40%]">
//             <h1 className="text-[#111827] font-medium">Active posts map</h1>
//             <p className="text-desc mt-2 mb-3">Lorem description of maps usage</p>
