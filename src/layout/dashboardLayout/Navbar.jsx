...
const Navbar = ({  showSidebar, toggleShowSodebar }) => {
  ...
  return (
    <div className= "dark:bg-gray-800 m-4 rounded-lg mb-0 bg-white py-5  text-gray-300 h-14  fixed top-0 w-full p-4 mr-20 z-20 px-10	">
      <nav className="flex items-center justify-between px-4">
        ...
        <div 
  className='flex pr-10 items-center gap-8 justify-end w-full text-sm '
  
        >
        <button style={{width:"200px"}}  className='hidden  bg-gradient-to-r from-tealCustom via-whiteTransparent to-blackCustom lg:flex gap-3 items-center w-[200px] h-[50px] p-2   rounded-[8px] border-2 text-white'>
              <SlPresent />
                upgrade your plan
            </button>
