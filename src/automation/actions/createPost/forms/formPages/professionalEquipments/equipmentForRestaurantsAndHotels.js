...
const selectorsList = (options) => [
  {
    ...
    option: () =>
      durationOfAvailabilityOfSparePartsOption(
        lebonFormOptions.equipmentForRestaurantsAndHotelsOffer.durationOfAvailabilityOfSpareParts.options.indexOf(
...
export const equipmentForRestaurantsAndHotels = async (page, post) => {
  try {
    ...
    // write selling price
    await writeToInput(page, post.options.yourSellingPrice, yourSellingPrice);
