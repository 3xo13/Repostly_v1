          ...
          ></textarea>
             ...
             <div className="mb-6 flex flex-col lg:flex-row items-start lg:items-center gap-5">
                    ...
                    <div className="relative w-full lg:w-[80%]">
                        ...
                        />
                                <span className="absolute right-[1px] rounded-md rounded-t-none	 top-1/2 transform -translate-y-1/2 text-gray-400 w-[50px] h-full bg-gray-200 flex items-center justify-center">
                                $
                                </span>
                            </div>
                    </div>
