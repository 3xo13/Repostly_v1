...
import { medicalEquipmentOffer } from "@/automation/utils/variables/formSelectors/professionalEquipment/medicalEquipmentOfferSelectors";
const {
  adDescription,
  adTitle,
...
const selectorsList = (options) => [
  {
    ...
    option: () =>
      durationOfAvailabilityOfSparePartsOption(
        lebonFormOptions.medicalEquipmentOffer.durationOfAvailabilityOfSpareParts.options.indexOf(
...
export const medicalEquipment = async (page, post) => {
  try {
