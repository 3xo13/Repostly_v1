                    ...
                    isOpen && (
                        <div
                            ...
                            <ul role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                <li>
                                    <a href="#" className={dropdownLinkStyle} onClick={closeDropdown}>
                                        <CiUser/>
...
const dropdownLinkStyle = " flex items-center gap-2 block p-4 py-2 text-sm text-gray-400 hover:text-teal-" +
        "500 capitalize"
